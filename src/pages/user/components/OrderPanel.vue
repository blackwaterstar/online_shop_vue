                    ...
                    <div>
                        <div class="order-box">
                            ...
                            >
                                ...
                                <el-descriptions-item>
                                    <template slot="label"> 操作</template>
                                    <el-button type="primary" @click="openform(order)" size="mini"
                                               :disabled="order.tOrder.paystatue === '已付款'">修改
                                    </el-button>
                                    <el-dialog title="输入新的收货信息" :visible.sync="dialogFormVisible"
                                        ...
                                        <div slot="footer" class="dialog-footer">
                                            <el-button type="primary" @click="handleSummit(order1.tOrder.orderId)">修改
                                            </el-button>
                        ...
                        <div v-for="comment in order.comments" :key="comment.comment.commentId">
                            <div class="comment-item">
                                <div class="comment-content">
                                    <el-tag type="success">已买{{ comment.pname }}</el-tag>
                                    <br/>
...
<script>
    ...
    import {apiGetList2, apiGetOrder, apiUpdatestatme, apiUpdateOrder} from "@/api/order.js";
    ...
    export default {
        ...
        methods: {
            ...
            openOrderPanel1() {
                this.$router.push("/user/orderPanel1")
            },
            // 提交购物车内订单
            ...
            initData() {
                apiGetList2({userId: this.$store.state.user.user.userId}).then((res) => {
            ...
            openform(order) {
                ...
                this.order1 = order;
                this.ruleForm.orderUser = order.tOrder.orderUser,
                this.ruleForm.orderAddr = order.tOrder.orderAddr,
                this.ruleForm.orderTel = order.tOrder.orderTel
            },
            // openform(order) {
            //   this.$layer.prompt(
            //           {
            ...
            //             } else {
            //               console.log(
            //                       `获取弹框的信息 姓名：${$("#username").val()} 年龄：${order.orderId}`
            //               );
